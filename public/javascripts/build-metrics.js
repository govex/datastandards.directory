function buildMetrics (metric) { 
	...
	if (metric.open == "Yes") { // Generally-speaking: if metric === Yes, then output this icon, else if metric === No, then output this other icon, etc... 
		...
		var open = '<a title="Open License" ><button type="button" id="metric" style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-unlock" aria-hidden="true"></i></button></a>';
		metrics.push(open)
	}
	if (metric.transferability == "Yes"){
		...
		var trans = '<a title="Transferable to Other Jurisdictions: ' + metric.transferability_rationale + '"><button type="button" id="metric" style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-exchange" aria-hidden="true"></i></button></a>';
		metrics.push(trans);
	}
	if (metric.stakePart == "Yes"){
		...
		var stakePart = '<a title="Stakeholder Participation: ' + metric.stakeholder_participation_rationale + '"><button type="button" id="metric"  style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-group" aria-hidden="true"></i></button></a>';
		metrics.push(stakePart);
	}
	if (metric.consensus_government == "Yes"){
		...
		var conGov = '<a title="Consensus-Based Governance: ' + metric.consensus_government_rationale + '"><button type="button" id="metric"  style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-thumbs-up" aria-hidden="true"></i></button></a>';
		metrics.push(conGov);
	}
	if (metric.extensions == "Yes"){
		...
		var ext = '<a title="Extensions: ' + metric.extensions_rationale + '"><button type="button" id="metric"  style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-external-link" aria-hidden="true"></i></button></a>';
		metrics.push(ext);
	}
	if (metric.human_readable == "Yes"){
		...
		var human = '<a title="Human Readable: ' + metric.human_readable_rationale + '"><button type="button" id="metric"  style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-eye" aria-hidden="true"></i></button></a>';
		metrics.push(human);
	}
	if (metric.machine_readable == "Yes"){
		...
		var machine = '<a title="Machine Readable: ' + metric.machine_readable_rationale + '"><button type="button" id="metric"  style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-desktop" aria-hidden="true"></i></button></a>';
		metrics.push(machine);
	}
	if (metric.requires_realtime == "Yes"){
		...
		var time = '<a title="Requires Up-To-Date Data: ' + metric.requires_realtime_rationale + '"><button type="button" id="metric"  style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-clock-o" aria-hidden="true"></i></button></a>';
		metrics.push(time);
	}
	if (metric.metadata == "Yes"){
		...
		var meta = '<a title="Takes into Account Associated Metadata for the Dataset: ' + metric.metadata_rationale + '"><button type="button" id="metric"  style="color:white; background-color: #37393B"><i id="metricIcon" class="fa fa-file" aria-hidden="true"></i></button></a>';
		metrics.push(meta);
	}
